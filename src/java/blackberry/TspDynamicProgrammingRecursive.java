...
public class TspDynamicProgrammingRecursive {
    ...
    public static void main (String[] args) {
        ...
        for (double[] row : distanceMatrix) java.util.Arrays.fill (row, 0);
...
//        distanceMatrix[5][1] = distanceMatrix[1][5] = 12;
        distanceMatrix[0][1] = distanceMatrix[1][0] = 6;
        distanceMatrix[0][2] = distanceMatrix[2][0] = 7;
        distanceMatrix[0][3] = distanceMatrix[3][0] = 2;
        distanceMatrix[0][4] = distanceMatrix[4][0] = 9;
        distanceMatrix[0][5] = distanceMatrix[5][0] = 16;
        distanceMatrix[1][2] =  distanceMatrix[2][1] = 3;
        distanceMatrix[1][3] = distanceMatrix[3][1] = 11;
        distanceMatrix[1][4] = distanceMatrix[4][1] = 12;
        distanceMatrix[1][5] = distanceMatrix[5][1] = 15;
        distanceMatrix[2][3] = distanceMatrix[3][2] = 9;
        distanceMatrix[2][4] = distanceMatrix[4][2] = 18;
        distanceMatrix[2][5] = distanceMatrix[5][2] = 5;
        distanceMatrix[3][4] = distanceMatrix[4][3] = 13;
        distanceMatrix[3][5] = distanceMatrix[5][3] = 18;
        distanceMatrix[4][5] = distanceMatrix[5][4] = 13;
        ...
        // Run the solver
        TspDynamicProgrammingRecursive solver = new TspDynamicProgrammingRecursive (startNode, distanceMatrix);
